...
class Attention(nn.Module): # Luong Attention
...
class Decoder(nn.Module): # With Attention
    def __init__(self, vocab_size, padded_idx, emb_dim, enc_hid_dim, dec_hid_dim, dropout):
        ...
        self.transform = nn.Linear   (enc_hid_dim * 2 + dec_hid_dim, vocab_size)

    def forward(self, src, dec_hiddens, enc_outputs, enc_masks): # different from Bahdanau Attention
        '''
        Params:
